...
const SEED_FORMULAS = [
  {
    ...
    formula_data: {
      ingredients: [
        { name: 'Cyclopentasiloxane', inci_name:'Cyclopentasiloxane', percentage: 30.0, function: '용매/텍스처', phase: 'B' },
        { name: 'Titanium Dioxide', inci_name:'Titanium Dioxide', percentage: 15.0, function: '자외선 차단/커버', phase: 'C' },
        { name: 'Glycerin', inci_name:'Glycerin', percentage: 5.0, function: '보습', phase: 'A' },
        { name: 'Niacinamide', inci_name:'Niacinamide', percentage: 2.0, function: '미백/진정', phase: 'C' },
        { name: 'PEG-10 Dimethicone', inci_name:'PEG-10 Dimethicone', percentage: 3.0, function: '유화제', phase: 'B' },
      ],
  ...
  },
  {
    ...
    formula_data: {
      ingredients: [
        { name: 'Titanium Dioxide', inci_name:'Titanium Dioxide', percentage: 20.0, function: '자외선 차단', phase: 'C' },
        { name: 'Zinc Oxide', inci_name:'Zinc Oxide', percentage: 10.0, function: '자외선 차단', phase: 'C' },
        { name: 'Caprylic/Capric Triglyceride', inci_name:'Caprylic/Capric Triglyceride', percentage: 25.0, function: '기제', phase: 'B' },
        { name: 'Beeswax', inci_name:'Cera Alba', percentage: 12.0, function: '굳힘제', phase: 'B' },
      ],
  ...
  },
  {
    ...
    formula_data: {
      ingredients: [
        { name: 'Sodium Cocoyl Isethionate', inci_name:'Sodium Cocoyl Isethionate', percentage: 18.0, function: '계면활성제', phase: 'B' },
        { name: 'Glycerin', inci_name:'Glycerin', percentage: 8.0, function: '보습', phase: 'A' },
        { name: 'Niacinamide', inci_name:'Niacinamide', percentage: 2.0, function: '미백/진정', phase: 'C' },
        { name: 'Lactic Acid', inci_name:'Lactic Acid', percentage: 0.5, function: 'pH 조정', phase: 'C' },
        { name: 'Water', inci_name:'Aqua', percentage: 69.5, function: '정제수', phase: 'A' },
      ],
  ...
  },
  {
    ...
    formula_data: {
      ingredients: [
        { name: 'Bakuchiol', inci_name:'Bakuchiol', percentage: 0.5, function: '레티놀 대체/안티에이징', phase: 'C' },
        { name: 'Niacinamide', inci_name:'Niacinamide', percentage: 5.0, function: '미백/진정', phase: 'C' },
        { name: 'Glycerin', inci_name:'Glycerin', percentage: 7.0, function: '보습', phase: 'A' },
        { name: 'Hyaluronic Acid', inci_name:'Sodium Hyaluronate', percentage: 0.5, function: '보습/탄력', phase: 'A' },
        { name: 'Water', inci_name:'Aqua', percentage: 85.0, function: '정제수', phase: 'A' },
      ],
      total_percentage: 98.0,
